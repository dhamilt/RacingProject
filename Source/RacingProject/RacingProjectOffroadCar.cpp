...
#include "RacingProjectOffroadCar.h"
#include "RacingProjectOffroadWheelFront.h"
#include "RacingProjectOffroadWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"
#include "GameFramework/SpringArmComponent.h"

ARacingProjectOffroadCar::ARacingProjectOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = URacingProjectOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = URacingProjectOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = URacingProjectOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = URacingProjectOffroadWheelRear::StaticClass();
