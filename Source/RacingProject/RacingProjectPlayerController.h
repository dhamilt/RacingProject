...
#include "RacingProjectPlayerController.generated.h"

class UInputMappingContext;
class ARacingProjectPawn;
class URacingProjectUI;
 ...
 */
UCLASS(abstract)
class RACINGPROJECT_API ARacingProjectPlayerController : public APlayerController
{
	GENERATED_BODY()
...
protected:
	...
	TObjectPtr<ARacingProjectPawn> VehiclePawn;

	/** Type of the UI to spawn */
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = UI)
	TSubclassOf<URacingProjectUI> VehicleUIClass;

	/** Pointer to the UI widget */
	TObjectPtr<URacingProjectUI> VehicleUI;
